...
var file_network_cloud_cloudrpc_proto_rawDesc = string([]byte{
...
var (
	...
	file_network_cloud_cloudrpc_proto_rawDescData []byte
)

func file_network_cloud_cloudrpc_proto_rawDescGZIP() []byte {
	file_network_cloud_cloudrpc_proto_rawDescOnce.Do(func() {
		file_network_cloud_cloudrpc_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_network_cloud_cloudrpc_proto_rawDesc), len(file_network_cloud_cloudrpc_proto_rawDesc)))
	})
...
func file_network_cloud_cloudrpc_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_network_cloud_cloudrpc_proto_rawDesc), len(file_network_cloud_cloudrpc_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   137,
			NumExtensions: 0,
			NumServices:   1,
